...
A large language model (claude) will make decisions, form hypotheses, and determine which analyses to run, but our system will act as a multi-agent harness that regulates the analysis, 
and keeps a record of the exact steps involved.
